// features/admin/pages/manage_all_exhibitions_page.dart
// ============================================================================
...
class ManageAllExhibitionsPage extends ConsumerWidget {
  const ManageAllExhibitionsPage({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('All Exhibitions'),
      ),
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          _showExhibitionDialog(
            context,
            currentUser.id, // 👈 wajib isi
            null, // null = ADD MODE
          );
        },
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _AdminExhibitionCard(exhibition: exhibition);
            },
          );
        },
      ),
          ...
          children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      /// Organizer (⚠️ works, but N+1 query)
                      FutureBuilder<DocumentSnapshot>(
                        future: FirebaseFirestore.instance
                            .collection('users')
                            .doc(exhibition.organizerId)
                            .get(),
                        builder: (context, snapshot) {
                          if (!snapshot.hasData) {
                          ...
                          final organizerName = data['name'] ?? 'Unknown';
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 4),
                Text(
                  '${DateFormat('MMM dd').format(exhibition.startDate)}'
                      ' - ${DateFormat('MMM dd, yyyy').format(exhibition.endDate)}',
                  style: TextStyle(color: AppTheme.textSecondary),
                ),
              ],
            ),
            ...
            /// Booth count (⚠️ works, but N+1 stream)
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final boothCount = snapshot.data!.docs.length;
            ...
            Row(
              ...
              children: [
                TextButton.icon(
                  onPressed: () =>
                      context.push('/organizer/booths/${exhibition.id}'),
  ...
  Future<void> _deleteExhibition(BuildContext context) async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Are you sure? This will permanently delete the exhibition and all associated booths and bookings.',
        ),
        actions: [
          TextButton(
